...
LIMIT 0 , 500";
		...
		?>
		<tr>
			<td><?php echo $row['mb_id']; ?></td><td><?php echo $row['room_name']; ?></td><td><?php echo $row['booked_on']; ?></td><td><?php echo $row['registered_on']; ?></td><td><?php echo $row['name']; ?></td><td><?php echo $row['mobile']; ?></td><td><?php echo $row['email']; ?></td><td><?php echo $row['no_of_people']; ?></td><td><?php echo $row['address']; ?></td><td><?php echo "<a href='mamandurbookcancel.php?id=" . $row['mb_id']."' >Cancel</a>"; ?></td>
		</tr>
		<?php	
			}
