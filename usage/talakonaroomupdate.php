                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="display" id="all" width="100%">
                        ...
                        while ($row = mysql_fetch_array($result)) {
                            ...
                            <tr>
                                ...
                                <td><?php echo "<a href='talakonaroomdelete.php?id=" . $row['r_id'] . "' onClick=\"return confirm('Are You Sure ?');\" >Delete</a>"; ?></td>
                                <td><?php echo "<a href='talakonaroomdetailsupdate.php?id=" . $row['r_id'] . "' >update</a>"; ?></td>
                            </tr>
                            <?php
                        }
