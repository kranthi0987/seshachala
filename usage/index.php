                                ...
                                <section class="scrollable">
                                    <div class="wrapper">
                                        <div class="clearfix m-b">
                                            <a href="#" class="pull-left thumb m-r"> <i class="icon-user"
                                                                                        class="img-circle"></i> </a>
                                            <div class="clear">
                                                <div class="h3 m-t-xs m-b-xs">Prudhvi</div>
                                                <small class="text-muted"><i class="icon-map-marker"></i> Cordinator,
                                                    CBET
                                                </small>
                                            </div>
                                        </div>
                                        <div class="btn-group btn-group-justified m-b">
                                            <a class="btn btn-success btn-rounded" data-toggle="button"> <span
                                                        class="text">  Talakona </span> <span class="text-active"> <i
                                                            class="icon-eye-open"></i>  </span> </a>
                                            <a class="btn btn-info btn-rounded"> <span class="text">  Mamandur </span>
                                                <span class="text-active"> <i class="icon-eye-open"></i>  </span> </a>
                                        </div>
                                        <div>
                                            <small class="text-uc text-xs text-muted">Designation</small>
                                            <p>Community Coordinator</p>
                                            <small class="text-uc text-xs text-muted">Activities</small>
                                            <p><i class="icon-list-alt"></i> Organise room booking activities in
                                                communities of Talakona and mamandur.
                                                <br/><i class="icon-file"></i> Handle's account's data for
                                                Papavinasanam, Talakona & Mamandur.</p>
                                            <div class="line"></div>
                                            <small class="text-uc text-xs text-muted">connection</small>
                                            <p class="m-t-sm"><a href="twitter.com"
                                                                 class="btn btn-rounded btn-twitter btn-icon"><i
                                                            class="icon-twitter"></i></a> <a href="Facebook.com"
                                                                                             class="btn btn-rounded btn-facebook btn-icon"><i
                                                            class="icon-facebook"></i></a> <a href="google.com"
                                                                                              class="btn btn-rounded btn-gplus btn-icon"><i
                                                            class="icon-google-plus"></i></a></p>
                                        </div>
                                    </div>
                                </section>
                            </section>
                            ...
                            <section class="vbox">
                                <header class="header bg-light bg-gradient">
                                    <ul class="nav nav-tabs nav-white">
                                        <li class="active"><a href="#contact" data-toggle="tab">Contact notification</a>
                                        </li>
                                        <li class=""><a href="#events" data-toggle="tab">Events notification</a></li>
                                    </ul>
                                </header>
                                <section class="scrollable">
                                            ...
                                            <ul class="list-group no-radius m-b-none m-t-n-xxs list-group-lg no-border">
                                                ...
                                                while ($row = mysql_fetch_array($result)) {
                                                    ...
                                                    <li class="list-group-item">
                                                        <a href="#" class="thumb-sm pull-left m-r-sm"> <img
                                                                    src="images/avatar_default.jpg" class="img-circle">
                                                        </a>
                                                        <a href="#" class="clear">
                                                            <small class="pull-right"><?php echo $row['time']; ?></small>
                                                            <strong class="block"><?php echo $row['name']; ?> </strong>
                                                            <small> <?php echo " " . $row['message'] . " "; ?> </i></small>
                                                        </a>
                                                    </li>
                                                    <?php
                                ...
                                <section class="scrollable">
                                    ...
                                    <div class="wrapper">
                                        <section class="panel no-borders">
                                            <header class="panel-heading bg-success lter"><span class="pull-right">Last 10 days</span>
                                                <span class="h4"><?php echo array_sum($td) ?><br> <small
                                                            class="text-muted">Collected from Talakona</small> </span>
                                                <div class="text-center padder m-b-n-sm m-t-sm">
                                                    <div class="sparkline" data-type="line" data-resize="true"
                                                         data-height="65" data-width="100%" data-line-width="2"
                                                         data-line-color="#fff" data-spot-color="#fff"
                                                         data-fill-color="" data-highlight-line-color="#fff"
                                                         data-spot-radius="3"
                                                         data-data="[<?php echo $td[0] . " , " . $td[1] . ", " . $td[2] . ", " . $td[3] . ", " . $td[4] . ", " . $td[5] . ", " . $td[6] . ", " . $td[7] . ", " . $td[8] . ", " . $td[9] ?>]"></div>
                                                    <div class="sparkline inline" data-type="bar" data-height="45"
                                                         data-bar-width="6" data-bar-spacing="10"
                                                         data-bar-color="#92cf5c">
                                                        <?php echo $tc[0] . "," . $tc[1] . "," . $tc[2] . "," . $tc[3] . "," . $tc[4] . "," . $tc[5] . "," . $tc[6] . "," . $tc[7] . "," . $tc[8] . "," . $tc[9] ?>
                                                    </div>
                                                </div>
                                            </header>
                                            <div class="panel-body">
                                                <div><span class="text-muted">Total booked:</span> <span
                                                            class="h3 block"><?php echo array_sum($tc) ?></span></div>
                                                <div class="row m-t-sm">
                                                    <div class="col-xs-4">
                                                        <small class="text-muted block">loghuts</small>
                                                        <span><?php echo $tlog ?></span></div>
                                                    <div class="col-xs-4">
                                                        <small class="text-muted block">Dormetry</small>
                                                        <span><?php echo $tdor ?></span></div>
                                                </div>
                                            </div>
                                        </section>
                                        <section class="panel no-borders">
                                            <header class="panel-heading bg-success lter"><span class="pull-right">Last 10 days</span>
                                                <span class="h4"><?php echo array_sum($md) ?><br> <small
                                                            class="text-muted">Collected from Mamandur</small> </span>
                                                <div class="text-center padder m-b-n-sm m-t-sm">
                                                    <div class="sparkline" data-type="line" data-resize="true"
                                                         data-height="65" data-width="100%" data-line-width="2"
                                                         data-line-color="#fff" data-spot-color="#fff"
                                                         data-fill-color="" data-highlight-line-color="#fff"
                                                         data-spot-radius="3"
                                                         data-data="[<?php echo $md[0] . " , " . $md[1] . ", " . $md[2] . ", " . $md[3] . ", " . $md[4] . ", " . $md[5] . ", " . $md[6] . ", " . $md[7] . ", " . $md[8] . ", " . $md[9] ?>]"></div>
                                                    <div class="sparkline inline" data-type="bar" data-height="45"
                                                         data-bar-width="6" data-bar-spacing="10"
                                                         data-bar-color="#92cf5c">
                                                        <?php echo $mc[0] . "," . $mc[1] . "," . $mc[2] . "," . $mc[3] . "," . $mc[4] . "," . $mc[5] . "," . $mc[6] . "," . $mc[7] . "," . $mc[8] . "," . $mc[9] ?>
                                                    </div>
                                                </div>
                                            </header>
                                            <div class="panel-body">
                                                <div><span class="text-muted">Total booked:</span> <span
                                                            class="h3 block"><?php echo array_sum($mc) ?></span></div>
                                                <div class="row m-t-sm">
                                                    <div class="col-xs-4">
                                                        <small class="text-muted block">normal rooms</small>
                                                        <span><?php echo $mlog ?></span></div>
                                                    <div class="col-xs-4">
                                                        <small class="text-muted block">Dormetry</small>
                                                        <span><?php echo $mdor ?></span></div>
                                                </div>
                                            </div>
                                        </section>
                                        <section class="panel no-borders">
                                            <header class="panel-heading bg-success lter"><span class="pull-right">Last 3 months</span>
                                                <span class="h4">$540<br> <small class="text-muted">collected from Papavinasanam</small> </span>
                                                <div class="text-center padder m-b-n-sm m-t-sm">
                                                    <div class="sparkline" data-type="line" data-resize="true"
                                                         data-height="65" data-width="100%" data-line-width="2"
                                                         data-line-color="#fff" data-spot-color="#fff"
                                                         data-fill-color="" data-highlight-line-color="#fff"
                                                         data-spot-radius="3"
                                                         data-data="[400,210,200,325,250,460,345,250,250,250,400,380]"></div>
                                                    <div class="sparkline inline" data-type="bar" data-height="45"
                                                         data-bar-width="6" data-bar-spacing="10"
                                                         data-bar-color="#92cf5c">9,9,11,10,11,10,12,10,9,10,11,9,8
                                                    </div>
                                                </div>
                                            </header>
                                            <div class="panel-body">
                                                <div><span class="text-muted">Sales in June:</span> <span
                                        ...
                                        <section class="panel">
                                            <div class="text-center wrapper">
                                                <div class="sparkline inline" data-type="pie" data-height="150"
                                                     data-slice-colors="['#acdb83','#fb6b5b']">
                                                    <?php echo array_sum($td) . "," . array_sum($md) ?>
                                                </div>
                                            </div>
                                            <ul class="list-group list-group-flush no-radius alt">
                                                <li class="list-group-item"><span
                                                            class="pull-right"><?php echo array_sum($td) ?></span> <span
                                                            class="label bg-success">1</span> Talakona
                                                </li>
                                                <li class="list-group-item"><span
                                                            class="pull-right"><?php echo array_sum($md) ?></span> <span
                                                            class="label bg-danger">2</span> Mamandur
                                                </li>
                                            </ul>
                                        </section>
                                </section>
