        ...
        <section id="content">
            <section class="vbox">
                <header class="header bg-success bg-gradient">
                    <div class="btn-group">
                        <button type="button" onclick="location.href='mamandurbook.php'" class="btn btn-info trigger">
                            mamandur room bookings
                        </button>

                    </div>
                    <div class="btn-group">
                        <button type="button" onclick="location.href='roomcreate.php'"
                                class="btn btn-info trigger">Rooms adding
                        </button>
                ...
                <section class="scrollable wrapper">
                    <table cellpadding="0" cellspacing="0" border="0" class="display" id="all" width="100%">
                        ...
                        $query = "SELECT * FROM  `rooms` where location='mamandur'";
                        ...
                        while ($row = mysql_fetch_array($result)) {
                            ...
                            <tr>
                                ...
                                <td><?php echo "<a href='mamandurroomdelete.php?id=" . $row['r_id'] . "' onClick=\"return confirm('Are You Sure ?');\"  >Delete</a>"; ?></td>
                                <td><?php echo "<a href='mamandurroomdetailsupdate.php?id=" . $row['r_id'] . "' >update</a>"; ?></td>
                            </tr>
                            <?php
                        }
