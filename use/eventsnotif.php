...
<aside class="humm bg-white hide col-lg-6 b-l" id="email-content<?php echo $i; ?>"> <section class="vbox"> <section class="scrollable"> 
 <div class="text-sm padder m-t"> <div class="block clearfix m-b"> <a href="#" class="thumb-xs inline"><img src="images/avatar.jpg" class="img-circle"></a> <span class="inline m-t-xs"><?php echo $row['name']; ?> &lt;<?php echo $row['email']; ?>&gt; to me</span> <div class="pull-right inline"> <?php echo $row['date']; ?><div class="btn-group">   </div> </div> </div> <div class="line pull-in"></div> <p><?php echo " ".$row['message'] ?></p>  <blockquote> <em><br><br><i class="icon-phone"></i><?php echo " ".$row['mobile'] ?></em><em><br><br><i class="icon-envelope-alt"></i> <?php echo " ".$row['email'] ?></em> </blockquote> <div class="show">  </div>  </div> </div> </div> </section> </section> </aside>
