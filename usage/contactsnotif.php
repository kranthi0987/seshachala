                            ...
                            <section>
                                <section id="mail-nav" class="hidden-xs">
                                    <ul class="nav nav-pills nav-stacked no-radius">
                                        <li class="active"><a href="contactsnotif.php"> <i
                                                        class="icon-envelope-alt"></i> contact </a></li>
                                        <li><a href="eventsnotif.php"> <i class="icon-bookmark-empty"></i> Events</a>
                                        </li>
                                    </ul>
                                </section>
                            </section>
                            ...
                            <section class="scrollable">
                                <div class="text-sm padder m-t">
                                    <div class="block clearfix m-b"><a href="#" class="thumb-xs inline"><img
                                        ...
                                        <div class="pull-right inline"> <?php echo $row['time']; ?>
