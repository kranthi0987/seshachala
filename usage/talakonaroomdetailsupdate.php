...
//            $query = "UPDATE  rooms SET room_types ='$room_types',room_price = '$room_price',no_rooms = '$no_rooms',ac = '$ac',gyser = '$gyser', western = '$western',Beds='$beds' WHERE r_id='$id' ";
            $query = "UPDATE `rooms` SET `room_types` = '$room_types', `room_price` = '$room_price', `no_rooms` = '$no_rooms', `ac` = '$ac', `gyser` = '$gyser', `Western` = '$western', `Beds` = '$beds' location='Talakona' WHERE `rooms`.`r_id` = $id " ;
//            echo $query ;
            ...
            <section id="content">
                <section class="vbox">
                    <header class="header bg-success bg-gradient">
                        <div class="btn-group">
                            <button type="button" onclick="location.href='talakonabook.php'" class="btn btn-info trigger">Talakona room bookings</button>

                        </div>
                        <div class="btn-group">
                            <button type="button" onclick="location.href='talakonaroomupdate.php'"
                                    class="btn btn-info trigger">Talakona room updating
                            </button>
